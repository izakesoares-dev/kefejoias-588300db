...
import { steelBracelets } from "@/data/bracelet-products";
        ...
        <div className="max-w-7xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="font-body text-sm text-muted-foreground max-w-2xl mx-auto">
              Aço inoxidável antialérgico com pingentes de pedras naturais.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-display text-xl md:text-2xl text-foreground mb-2">
              Quer uma pulseira com outra pedra?
            </h2>
            <p className="font-body text-sm text-muted-foreground mb-4 max-w-xl mx-auto">
              Temos diversas pedras para montar sua pulseira de aço personalizada.
            </p>
            <a
              href="https://wa.me/5511996470414?text=Olá! Gostaria de encomendar uma pulseira de aço personalizada."
              target="_blank"
