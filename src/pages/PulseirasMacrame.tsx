        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto mb-2">
              Arte e natureza no pulso
            </p>
            <p className="font-body text-muted-foreground max-w-3xl mx-auto">
              Feitas à mão com técnicas artesanais e elementos naturais encapsulados em resina cristalina.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12 text-sm">
            <div className="flex items-center gap-2 text-muted-foreground">
              <span>🧶 Macramê artesanal feito à mão</span>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              <span>🌿 Elementos naturais eternizados em resina</span>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              <span>📏 Tamanho único ajustável</span>
            </div>
          </div>
        </div>
      </section>
