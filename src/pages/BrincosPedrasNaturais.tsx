...
import { stoneEarrings } from "@/data/earring-products";
import ProductCard from "@/components/ProductCard";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import WhatsAppButton from "@/components/WhatsAppButton";
import { Shield, Sparkles, Heart, Gem, Zap, Brain, Moon } from "lucide-react";
...
const BrincosPedrasNaturais = () => {
  const [activeFilter, setActiveFilter] = useState("todos");

  const filtered =
    activeFilter === "todos"
      ? stoneEarrings
      : stoneEarrings.filter((p) => {
        ...
        <div className="max-w-7xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="font-display text-3xl md:text-4xl text-foreground mb-1">
              Brincos com <span className="text-gradient-gold">Pedras</span>
            </h1>
      ...
      <section className="px-4 pt-1 pb-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <a
              href="https://wa.me/5511996470414?text=Olá! Gostaria de encomendar um brinco personalizado com uma pedra específica."
              target="_blank"
...
export default BrincosPedrasNaturais;
